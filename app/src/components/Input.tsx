    ...
    async function submitPrompt(): Promise<void> {
        ...
        if (!response || !response.data) {
            alert(
                ...
                ? response.errorMessage
                : "There was an error communicating with OpenAI. Please try again later."
            );
            return;
        }
        ...
        <div className="relative w-[32rem] mt-[5]">
            ...
            >
                <textarea
                    ...
                    className="peer h-full min-h-[70px] w-full !resize-none rounded-[7px] 
                                border border-blue-gray-200 bg-transparent px-3 py-2.5 
                                ...
                                dark:border-gray-600 dark:bg-gray-700 dark:placeholder-shown:border-t-gray-600
                                dark:placeholder-shown:border-gray-600
                                dark:focus:border-gray-600 dark:focus:border-t-transparent
                            "
                    placeholder=" "></textarea>
                <label
                    className="
                            before:content[' '] after:content[' '] pointer-events-none absolute left-0 -top-1.5
                            ...
                            peer-focus:after:!border-gray-900 peer-disabled:text-transparent peer-disabled:before:border-transparent
                            peer-disabled:after:border-transparent peer-disabled:peer-placeholder-shown:text-blue-gray-500
                            
                            dark:peer-focus:after:!border-gray-600 dark:peer-focus:before:!border-gray-600
                            dark:!border-gray-600 dark:peer-focus:text-gray-200
                        "
                >
                    Your Question
                </label>
